...
TRACELOGGING_DEFINE_PROVIDER(g_hV8JSIRuntimeTraceLoggingProvider,
                             "Microsoft.V8JSIRuntime",
                             (0x85a99459, 0x1f1d, 0x49bd, 0xb3, 0xdc, 0xe5,
                              0xef, 0x2a, 0xd0, 0xc2, 0xc8));

// Define the GUID to use in TraceLoggingProviderRegister
// {5509957C-25B6-4294-B2FA-8A8E41E6BC37}
TRACELOGGING_DEFINE_PROVIDER(g_hV8JSIInspectorTraceLoggingProvider,
                             "Microsoft.V8JSIInspector",
                             (0x5509957c, 0x25b6, 0x4294, 0xb2, 0xfa, 0x8a,
