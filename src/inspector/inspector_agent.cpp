...
class V8NodeInspector : public v8_inspector::V8InspectorClient {
 public:
  ...
  void destroyContext(v8::Local<v8::Context> context) {
...
void AgentImpl::removeContext(v8::Local<v8::Context> context) {
  inspector_->destroyContext(context);
}
...
void Agent::addContext(v8::Local<v8::Context> context,
  ...
  return impl->addContext(context, context_name);
}
...
std::shared_ptr<Agent> Agent::get_shared() { return shared_from_this(); }
